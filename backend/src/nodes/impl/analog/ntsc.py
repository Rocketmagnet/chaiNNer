...
RingPattern = np.load('C:/Users/Hugo/AppData/Local/chaiNNer/app-0.20.1/resources/src/packages/chaiNNer_standard/image_adjustment/adjustments/ringPattern.npy')
...
def non_random_ntsc() -> Ntsc:
    ntsc = Ntsc(random=NumpyRandom(0))
    return ntsc
